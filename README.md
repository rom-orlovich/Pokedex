...
During the development process, we were asked to make a migration between MongoDB and PostgreSQL databases and kept only 10,000 pokemons. 

## What have I  learnd?
1. How to create server-side by creation meaningful routes and controllers.
2. How to create MongoDB and PostgreSQL databases and how make a migration between them.
...
2. **Filter pokemons by their name** - The user able to filter the display of pokemons by their names.
3. **Favoirte pokemons list** - The user can create and remove his favorite pokemons list.
